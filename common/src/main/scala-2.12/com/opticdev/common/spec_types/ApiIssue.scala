...
case class NoResponses(identifier: String,
                       ...
                       doctag: String = "issue-endpoint-styles",
                       level: Level = SpecError) extends ApiIssue
...
case class RequestBodyWithoutSchema(identifier: String,
                                    ...
                                    doctag: String = "issue-ambiguous-request-body",
                                    level: Level = SpecError) extends ApiIssue
...
case class RequestBodyWithoutContentType(identifier: String,
                                         ...
                                         doctag: String = "issue-ambiguous-request-type",
                                         level: Level = SpecError) extends ApiIssue
...
case class ResponseBodyWithoutSchema(identifier: String,
                                     ...
                                     doctag: String = "issue-ambiguous-response-body",
                                     level: Level = SpecWarning) extends ApiIssue
...
case class ResponseBodyWithoutContentType(identifier: String,
                                          ...
                                          doctag: String = "issue-ambiguous-response-type",
                                          level: Level = SpecWarning) extends ApiIssue